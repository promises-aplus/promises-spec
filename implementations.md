...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><a href="https://github.com/cumt-robin/promises-aplus-robin">promises-aplus-robin</a></td>
            <td>a lightweight Promises/A+ implementation that is able to detect circular thenable chain.</td>
            <td>1.0</td>
        </tr>
    </tbody>
</table>
